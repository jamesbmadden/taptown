import"./modulepreload-polyfill.b7f2da20.js";import{c as R,s as ae,f as Le,m as Ce,t as U,a as Ae,i as ye,b as Pe,r as $,d as g,e as oe,w as q,g as v,h as Xe,j as K,n as Se,k as Ve,$ as ne,o as se,l as De,p as We,q as Ne,u as ce}from"./vendor.fcf43544.js";var je=`attribute vec4 aVertexPosition;
...
}`;function Ze(e,i){return new Promise((r,a)=>{const n=e.createTexture();e.bindTexture(e.TEXTURE_2D,n);const t=new Image;t.onload=()=>{e.texImage2D(e.TEXTURE_2D,0,e.RGBA,e.RGBA,e.UNSIGNED_BYTE,t),de(t.width)&&de(t.height)?e.generateMipmap(e.TEXTURE_2D):(e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.LINEAR)),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.NEAREST),r(n)},t.src=i})}function de(e){return(e&e-1)==0}function l(e,i){return new Promise(async(r,a)=>{const t=await(await fetch(i)).json(),d=t.scenes[t.scene],h=await(await fetch(t.buffers[0].uri)).blob();let c=[...d.nodes],f=0,T=[],x=[],E=[],m=[];for(;f<c.length;){let me=x.length/3;const b=t.nodes[c[f]];if(b.children&&c.push(...b.children),b.mesh!==void 0){let I=R();if(b.scale&&ae(I,I,b.scale),b.rotation){const w=R();Le(w,b.rotation),Ce(I,I,w)}b.translation&&U(I,I,b.translation);const X=t.meshes[b.mesh].primitives[0],fe=X.indices,Te=t.accessors[fe],Y=t.bufferViews[Te.bufferView],xe=h.slice(Y.byteOffset,Y.byteOffset+Y.byteLength),Ee=new Int16Array(await xe.arrayBuffer());T.push(...Ee.map(w=>w+me));const pe=X.attributes.POSITION,be=t.accessors[pe],G=t.bufferViews[be.bufferView],we=h.slice(G.byteOffset,G.byteOffset+G.byteLength),S=new Float32Array(await we.arrayBuffer());for(let w=0;w<S.length;w+=3){let k=[S[w],S[w+1],S[w+2]];Ae(k,k,I),x.push(...k)}const Re=X.attributes.NORMAL,Fe=t.accessors[Re],z=t.bufferViews[Fe.bufferView],Me=h.slice(z.byteOffset,z.byteOffset+z.byteLength),Ue=new Float32Array(await Me.arrayBuffer());E.push(...Ue);const ve=X.attributes.TEXCOORD_0,Ie=t.accessors[ve],H=t.bufferViews[Ie.bufferView],_e=h.slice(H.byteOffset,H.byteOffset+H.byteLength),Be=new Float32Array(await _e.arrayBuffer());m.push(...Be)}f++}const J=await Ze(e,t.images[0].uri),p=e.createBuffer();e.bindBuffer(e.ARRAY_BUFFER,p),e.bufferData(e.ARRAY_BUFFER,new Float32Array(x),e.STATIC_DRAW);const P=e.createBuffer();e.bindBuffer(e.ELEMENT_ARRAY_BUFFER,P),e.bufferData(e.ELEMENT_ARRAY_BUFFER,new Uint16Array(T),e.STATIC_DRAW);const ie=e.createBuffer();e.bindBuffer(e.ARRAY_BUFFER,ie),e.bufferData(e.ARRAY_BUFFER,new Float32Array(m),e.STATIC_DRAW);const re=e.createBuffer();e.bindBuffer(e.ARRAY_BUFFER,re),e.bufferData(e.ARRAY_BUFFER,new Float32Array(E),e.STATIC_DRAW),r({buffers:{index:P,vertex:p,texCoords:ie,normal:re},indexCount:T.length,texture:J})})}var Oe="data:model/gltf+json;base64,",Je="/taptown/assets/Road-x.25087994.gltf",Ye="/taptown/assets/Road-right.05535041.gltf",Ge="/taptown/assets/Road-left.e4d57c46.gltf",ze="/taptown/assets/Road-y.43b84893.gltf",He="/taptown/assets/Road-up.f33fbfbe.gltf",ke="/taptown/assets/Road-down.3aa34828.gltf",$e="/taptown/assets/Road-cross.c0149426.gltf",ge="/taptown/assets/Road-upleft.8e8e8992.gltf",qe="/taptown/assets/Road-leftdown.43e4587d.gltf",Ke="/taptown/assets/Road-downright.2ee19715.gltf",et="/taptown/assets/Road-rightup.f9b3a2d6.gltf",tt="/taptown/assets/Road-T.dd27be2f.gltf",it="/taptown/assets/Road-l-.8fa437e2.gltf",rt="/taptown/assets/Road--l.cec3388c.gltf",at="/taptown/assets/Road-_l_.04dac8e2.gltf",ot="/taptown/assets/Road-single.f2299542.gltf",nt="/taptown/assets/outofbounds.8b7ad541.gltf",st="/taptown/assets/Cafe.5a05628e.gltf";const u=[null];let ue=!1;async function ct(e){u[0]=await l(e,Oe),u[1]=await l(e,Je),u[2]=await l(e,Ye),u[3]=await l(e,Ge),u[4]=await l(e,ze),u[5]=await l(e,He),u[6]=await l(e,ke),u[7]=await l(e,$e),u[8]=await l(e,ge),u[9]=await l(e,qe),u[10]=await l(e,Ke),u[11]=await l(e,et),u[12]=await l(e,tt),u[13]=await l(e,it),u[14]=await l(e,rt),u[15]=await l(e,at),u[16]=await l(e,ot),u[254]=await l(e,nt),u[255]=await l(e,st),ue=!0}function V(e,i,[r,a],n,t,d){if(!ue)throw"Models aren't loaded!";const s=u[i];if(!s)return;const h=R();U(h,d,[r*2,0,a*2]);{const f=3,T=e.FLOAT,x=!1,E=0,m=0;e.bindBuffer(e.ARRAY_BUFFER,s.buffers.vertex),e.vertexAttribPointer(n.attribLocations.vertexPosition,f,T,x,E,m),e.enableVertexAttribArray(n.attribLocations.vertexPosition)}{const f=3,T=e.FLOAT,x=!1,E=0,m=0;e.bindBuffer(e.ARRAY_BUFFER,s.buffers.normal),e.vertexAttribPointer(n.attribLocations.normalPosition,f,T,x,E,m),e.enableVertexAttribArray(n.attribLocations.normalPosition)}{const f=2,T=e.FLOAT,x=!1,E=0,m=0;e.bindBuffer(e.ARRAY_BUFFER,s.buffers.texCoords),e.vertexAttribPointer(n.attribLocations.textureCoordPosition,f,T,x,E,m),e.enableVertexAttribArray(n.attribLocations.textureCoordPosition)}e.bindBuffer(e.ELEMENT_ARRAY_BUFFER,s.buffers.index),e.useProgram(n.program),e.uniformMatrix4fv(n.uniformLocations.projectionMatrix,!1,t),e.uniformMatrix4fv(n.uniformLocations.modelViewMatrix,!1,h);const c=R();ye(c,h),Pe(c,c),e.uniformMatrix4fv(n.uniformLocations.normalMatrix,!1,c),e.activeTexture(e.TEXTURE0),e.bindTexture(e.TEXTURE_2D,s.texture),e.uniform1i(n.uniformLocations.texture,0),e.drawElements(e.TRIANGLES,s.indexCount,e.UNSIGNED_SHORT,0)}class dt{constructor(){this.x=0,this.z=0,this._pointerDown=!1,this._velocityX=0,this._velocityY=0,this._inFocusMode=!1,this.cameraMatrix=R(),U(this.cameraMatrix,this.cameraMatrix,[0,0,-3]),$(this.cameraMatrix,this.cameraMatrix,45*Math.PI/180),g(this.cameraMatrix,this.cameraMatrix,45*Math.PI/180),document.addEventListener("pointerdown",i=>{this._pointerDown=!0,this._prevPointerX=i.clientX,this._prevPointerY=i.clientY}),document.addEventListener("pointerup",()=>this._pointerDown=!1),document.addEventListener("pointermove",i=>{this._pointerDown&&(this._moveCamera(i.clientX-this._prevPointerX,i.clientY-this._prevPointerY),this._velocityX=i.clientX-this._prevPointerX,this._velocityY=i.clientY-this._prevPointerY),this._prevPointerX=i.clientX,this._prevPointerY=i.clientY})}_moveCamera(i,r){if(this._inFocusMode)return;const a=i/this._pixelToTileX,n=r/this._pixelToTileZ*1.425,t=[a,n];oe(t,t,[0,0],45*Math.PI/180),this.x-=t[0],this.z-=t[1],U(this.cameraMatrix,this.cameraMatrix,[t[0],0,t[1]])}setPixelToTileRatio(i,r){this._pixelToTileX=i,this._pixelToTileZ=r}update(i){let r=i/16.66667;this._pointerDown||(this._velocityX=Math.floor(Math.abs(this._velocityX)/10.25*r)*Math.sign(this._velocityX)*10*r,this._velocityY=Math.floor(Math.abs(this._velocityY)/10.25*r)*Math.sign(this._velocityY)*10*r,this._moveCamera(this._velocityX,this._velocityY))}enterFocus([i,r]){this._inFocusMode=!0;const a=Date.now(),n=()=>{let t=(Date.now()-a)/1e3;t>1&&(t=1);const d=-this.x*(1-t)+(-i*2+innerWidth/200)*t,s=-this.z*(1-t)+(-r*2+innerHeight/200)*t,h=1;this.cameraMatrix=R(),U(this.cameraMatrix,this.cameraMatrix,[0,1,-3]),$(this.cameraMatrix,this.cameraMatrix,45*Math.PI/180),g(this.cameraMatrix,this.cameraMatrix,45*Math.PI/180),ae(this.cameraMatrix,this.cameraMatrix,[h,h,h]),U(this.cameraMatrix,this.cameraMatrix,[d,0,s]),t<1&&requestAnimationFrame(n)};requestAnimationFrame(n)}exitFocus(){this.cameraMatrix=R(),U(this.cameraMatrix,this.cameraMatrix,[0,1,-3]),$(this.cameraMatrix,this.cameraMatrix,45*Math.PI/180),g(this.cameraMatrix,this.cameraMatrix,45*Math.PI/180),U(this.cameraMatrix,this.cameraMatrix,[-this.x,0,-this.z]),this._inFocusMode=!1}}function ut(){return new Worker("/taptown/assets/ambient.84990750.js",{type:"module"})}function ht(){return new Worker("/taptown/assets/buildings.4da7c4f3.js",{type:"module"})}function lt(){return new Worker("/taptown/assets/people.8597cbc5.js",{type:"module"})}let he,L,D;const W=new MessageChannel,N=new MessageChannel,j=new MessageChannel,Q=new MessageChannel;async function mt(){const e=q(new ut);e.log();const i=q(new ht);i.log();const r=q(new lt);return r.log(),he=await new e(v(j.port1,[j.port1]),v(Q.port2,[Q.port2])),L=await new i(v(W.port1,[W.port1]),v(N.port2,[N.port2])),D=await new r(v(N.port1,[N.port1]),v(W.port2,[W.port2]),v(Q.port1,[Q.port1]),v(j.port2,[j.port2])),{ambient:he,buildings:L,people:D}}var ft=`.close-button {
  position: absolute;
  top: 1rem;
  right: 1rem;
  width: 2rem;
    ...
    height: 100%;
      ...
      <div class="tile-menu">
        ...
        <div class="residents">
          <h2>Residents</h2>
          <ul>
            ${(i=this.residents)==null?void 0:i.map(r=>ne`<li>${r.name[0]} ${r.name[1]}</li>`)}
          </ul>
        </div>
      </div>
    `}};C.styles=Xe([ft]);Z([K()],C.prototype,"x",void 0);Z([K()],C.prototype,"z",void 0);Z([K()],C.prototype,"residents",void 0);C=Z([Se("tt-tile")],C);const Tt=document.querySelector(".money"),xt=document.querySelector(".population");function Et(e){Tt.textContent=`$${e.money}`,xt.textContent=`${e.population}`}function pt(e,i){const r=document.createElement("tt-tile");r.x=e,r.z=i,document.body.appendChild(r)}var bt=`attribute vec4 aVertexPosition;
attribute vec3 aNormal;
attribute vec2 aTextureCoord;
